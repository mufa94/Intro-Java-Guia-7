...
o Si no se cumple ninguno de los valores anteriores mostrar el mensaje “No existe un valor válido para tipo de bomba”
    ...
    public static void main(String[] args) {
        // Statements the objects
           ...
           //Satetments the variables
           int motor;
   
           
           //Statements captures
           System.out.println(" Elija un valor para el tipo de motor que desea");
           motor = leer.nextInt();
           ...
           if( motor >= 1 && motor <= 5){
               switch (motor){
                   ...
                   break;
                   /*El equivalente al caso del if/else (de otro modo o de lo contrario) es el default para el swirch
                   default;
                   acciones*/
               }
